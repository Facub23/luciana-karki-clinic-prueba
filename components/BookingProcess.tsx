export type BookingBlockContent = {
  eyebrow: string;
  title: string;
  steps: {
    title: string;
...
export const defaultBookingContent: BookingBlockContent = {
  eyebrow: "Cómo reservar",
  title: "Un proceso simple, claro y orientado a tu caso",
  steps: [
    {
...
type BookingProcessProps = {
  content?: BookingBlockContent;
};

export default function BookingProcess({
  content = defaultBookingContent,
}: BookingProcessProps) {
  return (
