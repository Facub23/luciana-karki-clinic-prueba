      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="mx-auto mb-14 max-w-3xl text-center">
          ...
          <h2 className="mt-4 text-4xl font-light text-[#6b5b63] sm:text-5xl">
            Una mirada real al trabajo en clínica
          </h2>

          <p className="mt-5 text-lg leading-8 text-gray-600">
            Videos breves para mostrar resultados, proceso y detalles visuales
            que ayudan a entender mejor cada tratamiento antes de reservar.
          </p>
        </div>
